...
int main()
{
	...
	*/
	...
	/* Multiplication Logic Run in parallel
	* Multiplying matrix a and b and storing in array mult. 
	* Variable mult is shared accross processors while i, j, k are private
	*/
	#pragma omp parallel for shared(mult) private(i,j,k)
	for (i = 0; i<aRows; ++i)
		for (j = 0; j < bColumns; ++j)
		{
